...
object JavalibIRCleaner {
  ...
  private val toReadOnlySeqMethodName =
    MethodName("toSeq", Vector.empty, ClassRef(ReadOnlySeq))
  ...
  private val writeReplaceMethodName =
    MethodName("writeReplace", Vector.empty, ClassRef(ObjectClass))

  // LinkingInfo
  private val esVersionMethodName = MethodName("esVersion", Vector.empty, IntRef)
  private val isWebAssemblyMethodName = MethodName("isWebAssembly", Vector.empty, BooleanRef)
  private val linkerVersionMethodName = MethodName("linkerVersion", Vector.empty, ClassRef(BoxedStringClass))
