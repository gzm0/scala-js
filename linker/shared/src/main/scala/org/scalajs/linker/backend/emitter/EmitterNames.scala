...
private[emitter] object EmitterNames {
  ...
  val cloneMethodName = MethodName("clone", Vector(), ClassRef(ObjectClass))
  val getClassMethodName = MethodName("getClass", Vector(), ClassRef(ClassClass))
  val hashCodeMethodName = MethodName("hashCode", Vector(), IntRef)
  val toStringMethodName = MethodName("toString", Vector(), ClassRef(BoxedStringClass))

  val getNameMethodName = MethodName("getName", Vector(), ClassRef(BoxedStringClass))
  val getSuperclassMethodName = MethodName("getSuperclass", Vector(), ClassRef(ClassClass))
