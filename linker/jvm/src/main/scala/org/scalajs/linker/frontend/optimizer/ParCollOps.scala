...
private[optimizer] object ParCollOps extends AbsCollOps {
  ...
  def finishAdd[V](addable: Addable[V]): ParIterable[V] =
    addable.getAndSet(Vector()).toParArray
