 ...
 *
 * Attention: You cannot use this to from one function to another one in this
 * trait, since the this pointer is not properly identified as a
 ...
 */
trait RuntimeString { this: js.String =>
  ...
  //DO NOT IMPLEMENT intern(). It will not work as it should.
  // no weak references in JavaScript
  //def intern(): String
